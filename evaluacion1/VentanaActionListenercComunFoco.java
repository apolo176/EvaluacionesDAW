...
public class VentanaActionListenercComunFoco extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaActionListenercComunFoco frame = new VentanaActionListenercComunFoco();
	 ...
	 * Create the frame.
	 */
	public VentanaActionListenercComunFoco() {
		setResizable(false);
		setTitle("Foco");

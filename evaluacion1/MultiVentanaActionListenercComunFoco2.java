...
public class MultiVentanaActionListenercComunFoco2 extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MultiVentanaActionListenercComunFoco2 frame = new MultiVentanaActionListenercComunFoco2();
	 ...
	 * Create the frame.
	 */
	public MultiVentanaActionListenercComunFoco2() {
		setResizable(false);
		setTitle("Foco");

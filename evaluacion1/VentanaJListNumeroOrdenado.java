...
public class VentanaJListNumeroOrdenado extends JFrame implements ActionListener{
  ...
  private JButton btnLimpiar;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaJListNumeroOrdenado frame = new VentanaJListNumeroOrdenado();
	 ...
	 * Create the frame.
	 */
	public VentanaJListNumeroOrdenado() {
		setResizable(false);
		setTitle("VentanaJListNumeroOrdenado");

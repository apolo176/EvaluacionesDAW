...
public class VentanaJListNumeroVariosCamposOrdenado extends JFrame implements ActionListener,ListSelectionListener{
  ...
  private JTextField txtNombre;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaJListNumeroVariosCamposOrdenado frame = new VentanaJListNumeroVariosCamposOrdenado();
	 ...
	 * Create the frame.
	 */
	public VentanaJListNumeroVariosCamposOrdenado() {
		setResizable(false);
			...
			if(DNI.equals( ""))
			{
				...
				if (dlm.contains(DNI)) {
					JOptionPane.showMessageDialog(this, (String)"Error", "Error", JOptionPane.ERROR_MESSAGE);
						...
						//COMPARACION DE OBJETOOOOOOSSS
							
							
							if(DNI.compareTo(dlm.get(posicion)) < 0) {
							break;
						}
						posicion++;
						}
					
							dlm.add(posicion, DNI);
							String nombre;
